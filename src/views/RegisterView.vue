  ...
  <div class="flex justify-center items-center min-h-screen my-12">
    <Card class="w-3/4 md:w-[60%] lg:w-[40%]">
      <form class="space-y-4 p-6" @submit.prevent="onSubmit">
        <CardHeader>
          <CardTitle class="text-3xl">Register Yourself</CardTitle>
          <CardDescription>Enter your details</CardDescription>
        </CardHeader>
        <CardContent>
          <FormField v-slot="{ componentField }" name="first_name">
            <FormItem class="label_margin">
              <FormLabel class="text-inherit">First Name</FormLabel>
              <FormControl>
                <Input
                  type="text"
          ...
          <FormField v-slot="{ componentField }" name="last_name">
            <FormItem class="label_margin">
              <FormLabel class="text-inherit">Last Name</FormLabel>
              <FormControl>
                <Input
                  type="text"
                  v-bind="componentField"
          ...
          <FormField v-slot="{ componentField }" name="phone">
            <FormItem class="label_margin">
              <FormLabel class="text-inherit">Phone</FormLabel>
              <FormControl>
                <Input
                  type="text"
                  v-bind="componentField"
          ...
          <FormField v-slot="{ componentField }" name="dob">
            <FormItem class="label_margin">
              <FormLabel class="text-inherit">DOB</FormLabel>
              <Popover>
          ...
          <FormField v-slot="{ componentField }" name="gender">
            <FormItem class="label_margin">
              <FormLabel class="text-inherit">Gender</FormLabel>
              <FormControl>
          ...
          <FormField v-slot="{ componentField }" name="address">
            <FormItem class="label_margin">
              <FormLabel class="text-inherit">Address</FormLabel>
              <FormControl>
                <Input
                  type="text"
                  v-bind="componentField"
